	...
	getControlHTML : function(button_name) {
		...
		switch (button_name) {
			case "formatselect":
				...
				var formats = tinyMCE.getParam("theme_advanced_blockformats", "p,h1,h2,h3,h4,h5,h6", true).split(',');
				var lookup = [
	...
	getEditorTemplate : function(settings, editorId) {
		...
		switch(layoutManager) {
			case "SimpleLayout" : //the default TinyMCE Layout (for backwards compatibility)...
				...
				var defVals = {
					theme_advanced_buttons1 : "bold,italic,strikethrough,separator,justifyleft,justifycenter,justifyright,separator,formatselect,separator,removeformat,separator,charmap",
					theme_advanced_buttons2 : "bullist,numlist,separator,outdent,indent,separator,undo,redo,separator,link,unlink,image,cleanup,help,code",
				};
